...
> 前置知识：[《中间件地图》](../00-overview/middleware.md)、[《CarPropertyManager》](../02-carservice-api/carproperty-manager.md)
...
**下一篇**：[CarPropertyService 属性通路](../01-car-service/carproperty-source.md)
