...
> 难度：⭐⭐ 进阶
> 更新：2026-08-26
> 对照：[AOSP android-14.0.0_r67](../AOSP_VERSION.md)
...
1. [CarService 架构](../01-car-service/carservice-architecture.md) — 进程与子服务
2. [CarPropertyManager](../02-carservice-api/carproperty-manager.md) — 先把客户端 API 用对
3. [Vehicle HAL](../12-vehicle-hal/vehicle-hal.md) — 再看契约
4. [CarPropertyService](../01-car-service/carproperty-source.md) — 中间这一跳
5. [权限与分心](../08-permission/car-permission.md) · [电源](../01-car-service/car-power.md) · [音频](../06-audio/car-audio-service.md)

---

**下一篇**：[CarService 架构：从 SystemServer 到车辆服务](../01-car-service/carservice-architecture.md)
