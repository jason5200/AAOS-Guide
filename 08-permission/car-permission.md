...
> 前置知识：[《CarPropertyManager》](../02-carservice-api/carproperty-manager.md)
...
更细的 UI 适配见 [CarUxRestrictions](../01-car-service/car-ux.md)。

---

**下一篇**：[CarPowerManagementService](../01-car-service/car-power.md)
