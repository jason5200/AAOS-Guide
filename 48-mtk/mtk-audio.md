...
> 难度：⭐⭐⭐ 进阶
> 更新：2026-08-26
> 前置知识：[《CarAudioService》](../06-audio/car-audio-service.md)、[《联发科座舱地图》](mtk-aaos-map.md)
...
[CarAudio 一文](../06-audio/car-audio-service.md) 讲上半：usage 进哪条 bus、旋钮拧哪一组。  
...
座舱比手机多：**多音区、功放关机、ACC 掉电时序**。ACC 一断 HAL 还在写，容易 NE，去 [AEE](mtk-aee.md) 对一下是不是 audio 进程。
...
**下一篇**：[中间件地图](../00-overview/middleware.md)（从芯片再回到 CarService）
