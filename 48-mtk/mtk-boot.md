...
> 难度：⭐⭐⭐ 进阶
> 更新：2026-08-26
> 前置知识：[《联发科座舱地图》](mtk-aaos-map.md)、[《CarService 启动》](../01-car-service/carservice-startup-source.md)
...
- **休眠唤醒**：STR 回来要重新过一段时钟和显示 init，和冷启动 log 不一样。对照 [电源一文](../01-car-service/car-power.md) 里的 `SUSPEND_*`。
...
**下一篇**：[AEE：死机、NE、JE 怎么下手](mtk-aee.md)
