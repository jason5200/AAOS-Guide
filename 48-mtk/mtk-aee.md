...
- **熄火瞬间 NE**：电源回调里同步等 HAL，对照 [电源](../01-car-service/car-power.md)，别在 `SHUTDOWN_PREPARE` 里死锁。
...
**下一篇**：[音频：MTK HAL 接到 CarAudioService](mtk-audio.md)
