...
> 难度：⭐⭐ 进阶
> 更新：2026-08-26
> 对照：vendor BSP（各车企差一截）；中间件仍按 [AOSP 14](../AOSP_VERSION.md)
...
| 车速有、媒体没声 | audio HAL / DSP / tinyalsa | [CarAudioService](../06-audio/car-audio-service.md) |
| 倒车影像花、无图 | imgsensor / mtkcam / 显示通路 | 相机、Surface |
| 属性全 UNAVAILABLE | **不一定是 MTK** | 先 [VHAL](../12-vehicle-hal/vehicle-hal.md) |
...
2. [启动：Preloader 到 Android](mtk-boot.md)
3. [AEE：死机和 NE 怎么下手](mtk-aee.md)
4. [音频：DSP 接到 CarAudio](mtk-audio.md)

电源状态机仍读 [CarPowerManagementService](../01-car-service/car-power.md)。MTK 侧对应的是 **SoC 休眠 / 唤醒 / 时钟**，和 CPMS 握手的是你们的电源 HAL，不是再发明一套 Car API。

---

**下一篇**：[联发科座舱启动：Preloader 到 Android](mtk-boot.md)
